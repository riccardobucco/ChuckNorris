...
.directive('chuckLinechart', ['ChartRequester', 'CHUCK_DIR', 'GoogleCharts', function (ChartRequester, CHUCK_DIR, GoogleCharts) {
    return {
        restrict: 'E',
        scope: {},
        templateUrl: CHUCK_DIR + 'main/view/LineChartView.html',
            ...
            GoogleCharts.then(function () {
                ...
                function init() {
                    ...
                    switch(chartSettings.legendPosition) {
                        ...
                        case 'right':
                            options.chartArea = {top:"10%", left:"15%", width: '60%', height: '70%'}
                            break;

                        case 'left':
                            options.chartArea = {top:"10%", left:"20%", width: '60%', height: '70%'}
                            break;
                        ...
                        case 'bottom':
                            options.chartArea = {top:"9%", left:"18%", width: '70%', height: '60%'}
                            break;
