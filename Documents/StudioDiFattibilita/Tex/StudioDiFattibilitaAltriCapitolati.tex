...
\section{Studio di fattibilità degli altri capitolati}
	...
	\subsection{Capitolato C5 - sHike: A smart cloud and mobile platform appliance for the safety and health in mountain hiking}
		...
		\subsubsection{Individuazione dei rischi}
			...
			\begin{itemize}
				\item Uno dei principali rischi di questo capitolato è il fatto che sia molto accattivante: è probabile che molti gruppi scelgano di svolgere tale progetto, aumentando la concorrenza e dunque il rischio di venire esclusi alla \insphase{Revisione dei Requisiti}.
