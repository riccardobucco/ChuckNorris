    ...
    \level{3}{Creazione della Dashboard}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                ...
                Sia per inserire un insieme vuoto di dati iniziali, sia per impostare le opzioni dei grafici, si fa uso dell'interfaccia \texttt{Norris::InternalAPIManager::Chart}, descritta e documentata all'interno del presente documento (vedi progettazione architetturale \insglo{Norris}).
            ...
            Nel diagramma viene rappresentata una singola iterazione dell'aggiornamento. Ovviamente essendo necessario fare polling sul server per mantenere i dati aggiornati è necessario ciclare le ultime 5 attività ma prima di cominciare un nuovo processo di aggiornamento (tramite la richiesta di dati al \insglo{server} \insglo{APS}), si attende per un tempo prefissato (minore è il tempo di aggiornamento, maggiore sarà la reattività e la precisione della \insglo{Dashboard}).
        \end{enumerate}