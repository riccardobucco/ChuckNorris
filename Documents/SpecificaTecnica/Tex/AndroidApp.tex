\level{1}{Applicazione Android}
    ...
    \level{2}{Descrizione delle componenti dell'Applicazione}
    ...
    \level{2}{Descrizione delle classi dell'Applicazione Android}
