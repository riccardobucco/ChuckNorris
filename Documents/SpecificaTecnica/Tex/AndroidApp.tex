\level{2}{Applicazione Android}
    ...
    \level{3}{Descrizione delle interazioni tra le componenti}
        ...
        Tale interazione rappresenta la selezione di un'\insglo{activity} modifica tale view. Ciò avviene ad ogni necessità di cambiare \insglo{Activity} e/o quando deve modificare o inizializare la view.
