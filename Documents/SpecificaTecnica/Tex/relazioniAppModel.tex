...
\item \textbf{Services} nel quale sono contenute le classi che si occupano di richiedere i grafici a \insglo{Norris}, di ricevere gli aggiornamenti dei grafici esistenti.
\end{itemize}

\level{6}{Relazioni tra le classi di Chuck::Model}
L'interfaccia ChartReceiver si occupa di ricevere da \insglo{Norris} nuovi grafici e gli aggiornamenti dei grafici già presenti. Per fare ciò deve reperire da NorrisSessionInfo l'indirizzo, l'endpoint e i cookie del \insglo{server} relativo alla sessione attiva.
