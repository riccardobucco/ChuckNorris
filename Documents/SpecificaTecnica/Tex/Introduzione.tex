...
\level{1}{Introduzione}
	...
	\level{2}{Scopo del documento}
		...
		Vengono a tale scopo descritte le componenti, le classi e i \insglo{design pattern} utilizzati per la realizzazione del \insglo{prodotto}. Infine viene fatto il tracciamento tra le componenti e i requisiti individuati nel documento \insdoc{Analisi dei Requisiti v3.00}.
