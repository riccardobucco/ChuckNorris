\level{1}{Chuck}
	...
	\level{2}{Descrizione delle componenti di Chuck}
	...
	\level{2}{Descrizione delle interazioni tra le componenti}
		\level{3}{Model - ViewModel}
	...
	\level{2}{Descrizione delle classi di Chuck}
	...
	\level{2}{Design pattern utilizzati con le classi}
