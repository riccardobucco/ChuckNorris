\level{2}{Chuck}
	...
	\level{3}{Descrizione delle interazione tra le componenti}
		...
		Quando il Web Developer utilizza un API di Chuck oppure quando arriva un messaggio da Norris, la componente apporta le opportune modifiche al Data Model, in modo che rispetti costantemente lo stato dei grafici da visualizzare.

		\level{4}{Chart View - Data Model}
		Quando la Chart View deve aggiornare la visualizzazione del grafico, effettua un query sul Data Model per ottenere le nuove informazioni relative al grafico da aggiornare.

		\level{4}{Data Model - Chart View}
		Quando avviene una modifica nel Data Model, una notifica avvisa la Chart View dell'avvenuto cambiamento.
		...
		Quando intraprende un'azione, il controller può effettuare delle modifiche nel Data Model.
