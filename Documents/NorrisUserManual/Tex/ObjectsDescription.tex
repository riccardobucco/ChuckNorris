	...
	\level{2}{Charts}
		...
		\level{3}{Settings}
			...
			\level{4}{Table}
				...
				\begin{description}
					\item[maxRows] It's an integer value which indicates the maximum number of rows of the \insglo{Table}. The minimum value is 1.
		...
		\level{3}{Updates}
			...
			\level{4}{Bar chart}
				The \insglo{Bar Chart} can be updated with the “\insglo{in place}” method. The parameter of such method must be an array of objects. Every object should have the properties described below.
				\begin{description}
			...
			\level{4}{Line chart}
				...
				The parameter of the “\insglo{in place}” method must be an array of objects. Every object should have the properties described below.
				\begin{description}
				...
				\end{description}
				The parameter of the “\insglo{stream}” method must be an array of objects. Every object should have the properties described below.
				\begin{description}
			...
			\level{4}{Table}
				...
				The parameter of the “\insglo{in place}” method must be an array of objects. Every object represents a cell to be modified with its new value. Every object has the following properties:
				\begin{description}
					...
					\end{description}
				\end{description}
				The parameter of the “\insglo{stream}” method must be an array of arrays of objects. The main array represents the set of rows that have to be added. Internal arrays represent rows of the Table. Every object represents a cell of the specified row, and they have the following properties:
				\begin{description}
					\item[color]: it's an object with the properties “r”, “g”, “b” and “a”. The first three are integers which can vary from 0 to 255. The “a” property must be a number included between 0 and 1.
					This object represents the color of text in the cell: it uses the RGB color model with an alpha channel to set opacity.
					\item[background]: it's an object with the same properties of “color” but it sets the background color of the cell.
