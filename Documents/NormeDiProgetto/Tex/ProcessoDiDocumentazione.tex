	...
	La stesura dei documenti deve essere fatta nel modo più accurato e completo possibile, in modo da ridurre i tempi nella \insglo{fase} di verifica.
		...
		\level{3}{Procedure}
			\level{4}{Procedura di formalizzazione dei documenti}
				...
				\end{figure}
	\level{3}{Strumenti}
		Per la stesura dei documenti si è scelto di utilizzare il \insglo{linguaggio di markup} \LaTeX{}, mentre per la rilevazione e la correzione degli errori ortografici vengono utilizzati appositi \insglo{script} realizzati dagli \insrole{Amministratori}. \\
		La descrizione dell'applicazione del linguaggio \LaTeX{} e degli \insglo{script} di verifica viene data nell'appendice \nameref{app:strumenti}.
