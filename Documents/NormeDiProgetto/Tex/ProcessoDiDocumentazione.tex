		...
		\level{3}{Norme}
			...
			\level{4}{Componenti grafiche}
				...
				\level{5}{Diagrammi UML} \label{sec:UML}
					...
					\item Il nome dei casi d'uso deve essere formato da "UC" seguito dalla sigla della macro-componente, dal numero gerarchico e, dopo uno spazio, dal nome descrittivo del caso d'uso; la sigla della macro-componente può essere:
						\begin{itemize}
						\item[-] N per i casi d'uso di Norris;
						\item[-] D per i casi d'uso della Dashboard;
						\item[-] A per i casi d'uso dell'applicazione Android.
						\end{itemize}
					...
					\item Il nome degli attori può essere composto di pù parole, in tal caso deve essere utilizzato il formato CamelCase.
					\end{itemize}
