		...
		\level{4}{Norme tipografiche}
			...
			\level{5}{Formati ricorrenti} \label{sec:formatiricorrenti}
				...
				\level{6}{Nomi dei file}
					...
					\end{itemize}
				\level{6}{Ettichette issue}
					Per fare riferimento ad una label di issue è necessario utilizzare il comando \LaTeX{} apposito: \textbackslash inslabel\{nome\_label\}. Esso garantisce la corretta scrittura dell'ettichetta rispetto le norme seguenti:
					\begin{itemize}
