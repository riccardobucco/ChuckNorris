\level{2}{Processo di documentazione}
	...
	La stesura dei documenti deve essere fatta nel modo più accurato e completo possibile, in modo da ridurre i tempi nella fase di verifica.
		\level{4}{Norme}
			\level{5}{Struttura dei documenti}
				...
				\level{6}{Frontespizio}
					...
					\begin{enumerate}
						...
						\end{enumerate}
					\end{enumerate}
				\level{6}{Informazioni sul documento}
					...
					\end{enumerate}
				\level{6}{Diario delle modifiche}
			...
			\level{5}{Norme tipografiche}
				\level{6}{Formattazione generale}
					\level{7}{Testatine}
				...
				\level{6}{Stile del testo}
					...
					\level{7}{Monospace}
						...
						\begin{itemize}
							...
							\item percorsi (path).
						\end{itemize}
				\level{6}{Composizione del testo}
					\level{7}{Elenchi}
					...
					\level{7}{Note a piè di pagina}
						...
						\end{itemize}
				\level{6}{Formati ricorrenti} \label{sec:formatiricorrenti}
					\level{7}{Date}
			...
			\level{5}{Tipologie dei documenti}
				\level{6}{Documenti informali}
				...
				\level{6}{Verbali} \label{sec:verbali}
					...
					\level{7}{Riunione interna}
						...
						\end{itemize}
			\level{5}{Versionamento dei documenti} \label{sec:versioni}
		...
		\level{4}{Procedure}
			\level{5}{Procedura di formalizzazione dei documenti}
