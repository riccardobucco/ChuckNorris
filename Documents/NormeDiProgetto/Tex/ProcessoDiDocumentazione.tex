	...
	La stesura dei documenti deve essere fatta nel modo più accurato e completo possibile, in modo da ridurre i tempi nella fase di verifica.
		\level{3}{Norme}
			...
			\level{4}{Componenti grafiche}
				...
				\level{5}{Diagrammi UML} \label{sec:UML}
					...
					Ogniqualvolta sia necessario utilizzare i diagrammi dei package devono essere rispettate le seguenti norme:
					\begin{itemize}
		...
		\level{3}{Procedure}
			\level{4}{Procedura di formalizzazione dei documenti}
				...
				\end{figure}
	\level{3}{Strumenti}
		Per la stesura dei documenti si è scelto di utilizzare il linguaggio di markup \LaTeX{}, mentre per la rilevazione e la correzione degli errori ortografici vengono utilizzati appositi script realizzati dagli \insrole{Amministratori}. \\
