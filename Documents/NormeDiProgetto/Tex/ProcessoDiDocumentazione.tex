\level{2}{Processo di documentazione}
	...
	\level{3}{Strumenti}
		...
		Per la rilevazione e la correzione degli errori ortografici viene utilizzato un apposito script realizzato dagli \insrole{Amministratori} del \groupname{}, che si appoggia al software Aspell, il quale è stato opportnamente configrato con il dizionario di lingua italiana.
