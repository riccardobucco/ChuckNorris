...
L'attività di codifica ha lo scopo di produrre il codice necessario alla realizzazione del prodotto richiesto. Il codice generato dovrà rispettare il più fedelmente possibile ciò che è stato definito nel documento \insdoc{Definizione di Prodotto v1.00}.
	\level{4}{Norme}
	...
	\begin{itemize}
		...
		\begin{lstlisting}
			/*
			* Name: [nome del file]
			* Package: [package al quale appartiene il file]
		...
		\begin{description}
			...
			\item[Package] indica il package al quale appartiene il file, comprensivo di gerarchia;
	...
	\end{itemize}
		...
		\level{5}{Java}
		Ciascun file Java, oltre a rispettare le norme sopra citate, deve seguire le linee guida \textit{Google Java Style Guide} reperibili all'indirizzo \insuri{https://google-styleguide.googlecode.com/svn/trunk/javaguide.html}. 
	\level{4}{Strumenti}
