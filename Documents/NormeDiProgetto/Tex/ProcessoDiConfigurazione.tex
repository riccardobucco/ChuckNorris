\level{2}{Processo di configurazione}
	...
	\level{3}{Gestione delle richieste di modifica}
		...
		Per agevolare lo svolgimento del progetto da parte di tutti i membri del \insglo{team} di sviluppo è stata predisposta una \textbf{macchina virtuale} contenente tutti gli strumenti \insglo{software} necessari, individuati fino al momento della stesura dell'ultima versione attuale del presente documento.
			\level{4}{Git}
			Per la gestione del \insglo{repository} si è scelto di utilizzare il sistema di versionamento distribuito \insglo{Git}. Oltre al servizio di repository, lo si utilizza per il controllo di versione e la gestione delle anomalie. \\
