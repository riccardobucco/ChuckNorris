\level{2}{Processo di configurazione}
	\level{3}{Norme}
		...
		\level{3}{Procedure}
			...
			\level{4}{Aggiornamento del repository}
					Per aggiornare il repository è necessario seguire correttamente la seguente procedura:
					\begin{enumerate}
	...
	\level{3}{Strumenti}
			...
			\level{4}{Strumenti per il deployment del prodotto}
				Come richiesto dal capitolato, il \textit{deployment} del prodotto avverrà attraverso Heroku, una piattaforma cloud pensata appositamente per la realizzazione e distribuzione di applicazioni online. Maggiori informazioni su questo strumento si trovano nell'appendice \nameref{app:strumenti} del presente documento.
