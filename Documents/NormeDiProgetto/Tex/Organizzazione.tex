	...
	\subsection{Riunioni}
		...
		\subsubsection{Convocazione di una riunione}
			...
			\paragraph{Riunione esterna}
				Spetta al \insrole{Responsabile di Progetto} accordare ua data, un orario e un luogo con il proponente e/o il committente per una riunione. Egli deve fare in modo, per quanto possibile, che possano essere presenti alla riunione la maggior parte dei membri del team.
