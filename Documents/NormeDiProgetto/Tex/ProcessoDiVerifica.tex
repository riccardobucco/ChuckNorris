				...
				\level{5}{Norris}
					\level{6}{Test di unità}
						...
						\begin{itemize}
							...
							\begin{figure}[H]
								\centering
								\includegraphics[scale=0.5]{Pics/TUPassing.jpg}
							...
							\begin{figure}[H]
								\centering
								\includegraphics[scale=0.4]{Pics/TUNotPassing.jpg}
					...
					\begin{itemize}
							...
							\begin{figure}[H]
								\centering
								\includegraphics[scale=0.5]{Pics/TIPassing.jpg}
							...
							\begin{figure}[H]
								\centering
								\includegraphics[scale=0.5]{Pics/TINotPassing.jpg}
