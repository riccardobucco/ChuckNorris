\section{Verifica}
	\subsection{Attività}
		...
		\subsubsection{Issue tracking}
			L'issue tracking è un attività di supporto dei \insrole{Verificatori}. Essa permettere non di tracciare tutti i potenziali difetti dalla comparsa fino alla risoluzione, ma consente al \insrole{Responsabile di Progetto} di assegnare i compiti di correzione ai singoli membri del team.
	...
	\subsection{Procedure}
		...
		\subsubsection{Segnalazione modifica con issue}
			La corretta procedura la gestione delle issue è descritta dal seguente diagramma:
