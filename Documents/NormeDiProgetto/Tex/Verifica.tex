\section{Verifica}
	...
	\subsection{Issue di verifica}
		Una issue è una issue di verifica se e solo se ad essa è stata assegnata un'etichetta di tipo \textit{Verifica}. Si può immaginare come una richiesta da parte di un \insrole{Verificatore} verso il \insrole{Project Manager} di modifica di un documento. Ogni \insrole{Verificatore} prima di compiere una modifica dovrà infatti creare una issue di verifica e potrà eseguirla solamente se accettata.\\
	...
	\subsection{Procedure}
		\subsubsection{Verifica dei documenti}
			...
			Durante l'esecuzione dell'intera procedura di verifica dei documenti è importante che i \insrole{Verificatori} tengano traccia di tutti gli errori pi\'u comuni. \\
		...
		\subsubsection{Issues di verifica}
			...
			\begin{enumerate}
				...
				\item quando viene accettata dal \insrole{Project Manager} si procede ad inserire la tipologia dell'errore sul \textit{Tracker};
