\section{Configurazione}
	...
	\subsection{Strumenti}
		...
		\subsubsection{Software per la stesura di documentazione nel linguaggio \LaTex{}}	
		...
		\subsubsection{script per l'automazione di attività di verifica}
			Gli \insrole{Amministratori di Sistema} hanno sviluppato alcuni script per l'automazione di attività di verifica come il controllo ortografico, il corretto utilizzo dei comandi \LaTex{}, il calcolo dell'indice Gulpease e la rilevazione di spazi errati.
