...
\level{2}{Norris}
	...
	\begin{itemize}
		...
		\item L'attore che rappresenta il ruolo degli sviluppatori di siti web è stato chiamato \emph{\insglo{Web developer}}. Oltre a rappresentare l'utente ad esso associato, tale attore ingloba al suo interno tutti i siti web che utilizzano grafici messi a disposizione da un \insglo{server} \insglo{Norris}.
