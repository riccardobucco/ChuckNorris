\level{1}{Standard di progetto}
	...
	Per gli standard di progettazione architetturale, si fa riferimento al documento \insdoc{Specifica Tecnica v5.00}.

	\level{2}{Standard di documentazione del codice}
	Per le norme da rispettare nella scrittura del codice, si fa riferimento al documento \insdoc{Norme di Progetto v7.00}.
	...
	Per le regole tipografiche da seguire, relative ai nomi delle entità, si fa riferimento al documento \insdoc{Norme di Progetto v7.00}.

	\level{2}{Standard di programmazione}
	Per gli standard di programmazione, si fa riferimento al documento \insdoc{Norme di Progetto v7.00}.

	\level{2}{Strumenti di lavoro}
	Per gli strumenti di lavoro da utilizzare durante la codifica, si fa rferimento al documento \insdoc{Norme di progetto v7.00}.
