\level{1}{Dashboard}
    ...
    \level{2}{Funzioni}
        Nel presente paragrafo vengono presentate le parti nelle quali è stato suddiviso il codice necessario alla creazione e all'aggiornamento della \insglo{Dashboard}. Tali parti fanno riferimento ai task che sono stati presentati e descritti nel documento \insdoc{Specifica Tecnica v4.00}.\\
