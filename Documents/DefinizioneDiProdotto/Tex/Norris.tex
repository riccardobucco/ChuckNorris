\level{1}{Norris}
    ...
    \level{2}{Diagrammi di sequenza}
        ...
        \level{3}{Creazione di un chart}
            ...
            \end{figure}
            \begin{enumerate}
                \item NorrisBridge invoca il metodo createChart di NorrisImpl in seguito all'utilizzo dell'\insglo{API} interna di \insglo{norris} per la creazione di un chart;
        ...
        \level{3}{Aggiornamento di un chart}
            ...
            \end{figure}
            \begin{enumerate}
                \item all'utilizzo dell'\insglo{API} interna di \insglo{Norris} per la richiesta di aggiornamento di un chart il ChartBridge invoca il metodo di aggiornamento nel modello dei dati (ChartImpl);
