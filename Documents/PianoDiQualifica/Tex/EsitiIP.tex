...
\level{1}{Resoconto delle varie attività di verifica - Fase IP}
	...
	\begin{table}[H]
		\centering
			\begin{tabu}{| l | c | c |}
				...
				Definizione di \insglo{prodotto} v2.00		& NC		& Superato \\ \hline
	...
	Si riportano di seguito le percentuali dei test di robustezza superati dalle componenti di \insglo{Norris}.
	\begin{table}[H]
		\centering
			\begin{tabu}{| l | c | c |}
				\hline
	...
	Si riportano di seguito le percentuali dei test di robustezza superati dalle componenti di \insglo{Chuck}.
	\begin{table}[H]
		\centering
			\begin{tabu}{| l | c | c |}
				\hline
