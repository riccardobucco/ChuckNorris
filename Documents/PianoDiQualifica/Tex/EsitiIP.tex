...
\level{1}{Resoconto delle varie attività di verifica - Fase IP}
	...
	\level{3}{Processo di sviluppo}
		...
		\level{4}{Produttività}
		Utilizzando la formula descritta all'interno del presente documento (sezione \nameref{sec:metriche}) è stata calcolata la produttività del processo di sviluppo, limitatamente all'attività di codifica. Questo indice è stato calcolato durante i due momenti di verifica previsti dal \insdoc{Piano di Progetto v5.00} per la \insphase{Fase P}.\\
