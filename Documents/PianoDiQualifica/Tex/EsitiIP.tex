...
Come è possibile notare dalla tabella la percentuale dei requisiti funzionali desiderabili soddisfatti da \insglo{Chuck} ha raggiunto un esito generalmente ottimale.
	...
	\level{4}{Livello CMM}
	Nonostante i progressi fatti nella capacità di gestione dei processi da parte del gruppo, non è ancora possibile affermare di essere giunti al quarto livello \insglo{CMM}, poiché non è ancora in grado di gestire appieno le misurazioni in un'ottica di miglioramento del processo.
	...
	\level{3}{Processo di sviluppo}
		...
		Grazie all'impiego di librerie grafiche estremamente ricche come quelle indicate nella \insdoc{Specifica Tecnica}, utilizzate nello sviluppo del \insglo{prodotto}, le risorse necessarie si sono rivelate leggermente inferiori rispetto alle previsioni.\\
					\begin{table}[H]
						...
						\end{tabu}
						\caption{Esiti del calcolo della Budget Variance dell'attività di codifica durante la Fase IP}
					\end{table}	
