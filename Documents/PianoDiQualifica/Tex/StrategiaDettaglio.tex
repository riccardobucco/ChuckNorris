\level{1}{La strategia di gestione della qualità nel dettaglio}
	\level{2}{Risorse}
		\level{3}{Risorse necessarie}
			...
			\level{4}{Risorse umane}
				...
				Una descrizione dettagliata di ciascun ruolo è presente all'interno delle \insdoc{Norme di Progetto v7.00}.
		...
		\level{3}{Risorse disponibili}
			...
			\level{4}{Risorse hardware}
				...
				\begin{itemize}
					\item un computer portatile per ogni membro del \insglo{team} (dotato del sistema operativo comune indicato nelle \insdoc{Norme di Progetto v7.00}).
				\end{itemize}
	...
	\level{2}{Standard, tecniche e principi utilizzati}
		\level{3}{Principio del “Rasoio di Occam”}
		...
		\level{3}{Tecniche di controllo della qualità di prodotto}
	...
	\level{2}{Misure e metriche} \label{sec:metriche}
		...
		\level{3}{Metriche per i processi}
			\level{4}{Capability Maturity Model} \label{subsec:metricaCMM}
			...
			\level{4}{Schedule Variance} \label{subsec:scheduleVariance}
				...
				\end{itemize}
				\level{4}{Budget Variance} \label{subsec:budgetVariance}
					...
					\end{itemize}
			\level{4}{Produttività} \label{subsec:produttivita}
			...
			\level{4}{Efficacia di una revisione} \label{subsec:effRevisione}
		...
		\level{3}{Metriche per i prodotti}		
			\level{4}{Metriche per i documenti}
				...
				\level{5}{Indice di leggibilità} \label{subsec:gulpease}
			...
			\end{table}
				\level{5}{Numero di requisiti funzionali realizzati} \label{subsec:numReqFunzionali}
					...
					\begin{description}
					    \item[\insphase{Fase P}] \hfill \\
							In tale \insglo{fase} si andranno a misurare i requisiti funzionali obbligatori. I range di accettazione per questa metrica sono riassunti nella seguente tabella:
						...
						\item[\insphase{Fase IP}] \hfill \\
							In tale \insglo{fase} si andranno a misurare i requisiti funzionali obbligatori e desiderabili. I range di accettazione per questa metrica sono:
						...
						\item[\insphase{Fase CP}] \hfill \\
							In tale \insglo{fase} si andranno a misurare i requisiti funzionali obbligatori, desiderabili e opzionali. I range di accettazione per questa metrica sono:
						...
						In quest'ultima \insglo{fase} si andranno a misurare i requisiti funzionali obbligatori, desiderabili e opzionali. I range di accettazione per questa metrica sono:
				...
				\level{5}{Percentuale di test di robustezza superati} \label{subsec:percTestRobustezza}
					...
					\end{itemize}
			\level{5}{Complessità ciclomatica} \label{subsec:complCiclomatica}
			...
			\level{5}{Numero di parametri di un metodo} \label{subsec:numParMet}
			...
			\level{5}{Numero di statement di un metodo} \label{subsec:numStatement}
			...
			I range di accettazione per questa metrica sono:
				...
				\end{itemize}
			\level{5}{Numero di campi dati di una classe} \label{subsec:numFields}
			...
			I range di accettazione per questa metrica sono:
				...
				\end{itemize}
			\level{5}{Livello di annidamento} \label{subsec:livAnnidamento}
			...
			\end{itemize}
		\level{5}{Grado di accoppiamento} \label{subsec:gradoAccoppiamento}
		...
		\item[\insglo{Fase} Completion of Product] L'applicazione delle metriche di qualità di questa \insglo{fase} segue lo stesso principio della precedente. I risultati delle metriche di processo verranno monitorati con maggiore frequenza per arrivare alla revisione di Qualifica con un buon livello di qualità.
