...
\section{Introduzione}
	...
	\subsection{Riferimenti utili}
		...
		\subsubsection{Elenco dei riferimenti informativi}
			\begin{itemize}
				\item \textbf{Analisi dei Requisiti}: \insdoc{Analisi dei Requisiti v1.0};
				\item \textbf{Piano di Progetto}: \insdoc{Piano di Progetto v1.0};
				\item \textbf{Studio di Fattibilità}: \insdoc{Studio di Fattibilità v1.0};
