...
\section{Introduzione}
	...
	\subsection{Riferimenti}
		\subsubsection{Normativi}
			\begin{itemize}
				\item Capitolato D'Appalto C3: \projectname: Real-time Business Intelligence. Reperibile all'indirizzo: \insuri{http://www.math.unipd.it/~tullio/IS-1/2014/Progetto/C3.pdf}
		...
		\subsubsection{Informativi}
			\begin{itemize}
				...
				\item ISO 9001: \insuri{http://en.wikipedia.org/wiki/ISO\_9001};
				\item ISO/IEC 9126:2001: \insuri{http//en.wikipedia.org/wiki/ISO/IEC\_9126};
				\item ISO/IEC 15504: \insuri{http//en.wikipedia.org/wiki/ISO/IEC\_15504};
			\end{itemize}
