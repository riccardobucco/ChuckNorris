\level{1}{Resoconto delle varie attività di verifica - Fase P}
	...
	\level{2}{Verifica dei prodotti}
				...
				\begin{table}[H]
					\centering
						\begin{tabu}{| l | c | c |}
							...
							Definizione di \insglo{prodotto} v1.00		& 84		& Superato \\ \hline
		...
		\level{3}{Codice}
			...
			In questa sezione sono riportate, per le parti del progetto implementate in questa prima \insglo{fase} di codifica, i risultati delle metriche calcolate nei momenti di verifica.
...
Come è possibile notare dalla tabella la percentuale dei requisiti funzionali obbligatori soddisfatti da \insglo{Norris} ha raggiunto un esito generalmente accettabile. 
\\ \\
...
\end{table}
Come è possibile notare dalla tabella la percentuale dei requisiti funzionali obbligatori soddisfatti da \insglo{Chuck} ha raggiunto un esito generalmente accettabile.

\level{4}{Numeri di parametri di un metodo}
Si riportano di seguito le percentuali dei metodi di \insglo{Norris} e \insglo{Chuck} per numero di parametri.
\begin{table}[H]
	\centering
...
\begin{table}[H]
      \centering
		...
		Definizione di \insglo{Prodotto} & 156 & 140	 \\ \hline
