...
\begin{table}[H]
	\centering
		\begin{tabu}{| l | c | c |}
			...
			Definizione di prodotto v3.00		& 63		& Superato  \\ \hline
...
Si riportano di seguito le percentuali di requisiti funzionali desiderabilli realizzati dalle componenti di Norris.
\begin{table}[H]
	\centering
		\begin{tabu}{| l | c | c |}
			\hline
...
Si riportano di seguito le percentuali di requisiti funzionali opzionali realizzati dalle componenti di Norris.
\begin{table}[H]
	\centering
		\begin{tabu}{| l | c | c |}
			\hline
...
\end{table}
Come è possibile notare dalla tabella la percentuale dei requisiti funzionali opzionali soddisfatti da Norris ha raggiunto un esito generalmente accettabile. 
\\ \\
Si riportano di seguito le percentuali di requisiti funzionali opzionali realizzati dalle componenti di Chuck.
\begin{table}[H]
	\centering
		\begin{tabu}{| l | c | c |}
			\hline
...
\end{table}
Come è possibile notare dalla tabella la percentuale dei requisiti funzionali opzionali soddisfatti da Chuck ha raggiunto un esito generalmente ottimale.
\\ \\
