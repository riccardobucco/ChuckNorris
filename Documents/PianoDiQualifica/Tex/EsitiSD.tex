...
Anche durante questa terza fase, secondo quanto riportato dal \insdoc{Piano di Progetto}, sono previsti più momenti in cui viene attivato il processo di verifica. Si riportano in questa sezione tutti i risultati ottenuti durante questi momenti. Ove fosse necessario, sono state tratte anche delle conclusioni sui risultati ottenuti e su come essi possano essere migliorati.
	...
	\level{2}{Verifica dei processi}
		\level{3}{Processo di documentazione}
			...
			Le risorse necessarie all'incremento dei documenti \insdoc{Norme di Progetto} e \insdoc{Glossario} si sono rivelate leggermente inferiori rispetto a quelle preventivate. Al contrario, le risorse impiegate per la stesura della \insdoc{Specifica Tecnica} sono state leggermente maggiori. Nel complesso il bilancio è positivo.\\
			Riportiamo di seguito i valori ottenenuti calcolando la Budget Variance sui tempi di stesura di ogni documento:
			\begin{table}[H]
					\centering
					\begin{tabu}{| l | c | c |}
							\hline
							...
							Piano di progetto vX.00				& 0 		& Superato  \\ \hline
							Norme di Progetto vX.00 			& 2\%		& Superato  \\ \hline
							Analisi dei Requisiti vX.00	 	& 0		& Superato  \\ \hline
							Piano di Qualifica vX.00 			& 0		& Superato  \\ \hline
							Specifica Tecnica vX.00 			& -7\%		& Superato  \\ \hline
							Glossario vX.00					 	& 5\% 		& Superato  \\ \hline
						\end{tabu}
		...
		\level{3}{Processo di verifica}
			...
			\level{4}{Budget Variance}
			Le risorse utilizzate nel processo di verifica sono pari a quelle preventivate. I valori della Budget Variance risultano quindi positivi.
			\level{4}{Produttività}
