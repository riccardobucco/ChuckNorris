...
\section{Resoconto delle varie attività di verifica - Fase A}
	...
	\subsection{Verifica dei prodotti}
		\subsubsection{Documenti}
			...
			\paragraph{Verifiche automatizzate}
				Le attività di verifica automatizzate, oltre a rispettare le procedure descritte all'interno dell \insdoc{Norme di Progetto}, fanno uso 
	...
	\subsection{Verifica dei processi}
		\subsubsection{Processo di documentazione}
			\paragraph{Livello CMM}
				...
				ancora la principale caratteristica richiesta dal terzo livello, ovvero la proattività. Infatti, è capitato durante la Fase A che 
			...
			\paragraph{Produttività}
				...
				la Fase A, e ciò è stato fatto per ogni documento che era stato redatto nel periodo antecedente la verifica. Ogni documento è stato 
				...
				Fase A nei quali è stato applicato il processo di verifica. Il grafico fa riferimento alla tabella precedente.
				\begin{figure}[H]
					\centering
		...
		\subsubsection{Processo di verifica}
			\paragraph{Livello CMM}
				...
				nella scala prevista da CMM. Il processo ha infatti superato l'iniziale stato caotico nel quale si trovava all'inizio della Fase A
			...
			\paragraph{Produttività}
				...
				la Fase A. Di seguito vengono riportati i valori calcolati e una loro rappresentazione grafica.
				\begin{table}[H]
					\centering
				...
				\begin{figure}[H]
					...
					\caption{Produttività del processo di verifica durante la Fase A}
				\end{figure}
				Dai dati si può notare come la produttività del processo di verifica non sia aumentata in modo sostanziale durante la Fase A, nonostante 
			...
			\paragraph{Efficacia di una revisione}
				...
				varie revisioni che sono state fatte durante la Fase A. Di seguito vengono riportati i valori calcolati e una loro rappresentazione grafica.
				\begin{table}[H]
					\centering
					\begin{tabu}{| l | c | c | c | c | c | c | c |}
						\hline
				...
				\begin{figure}[H]
					...
					\caption{Efficacia delle revisioni durante la Fase A}
				\end{figure}
				Dal grafico sopra presentato si può notare come non via sia stato un miglioramento tangibile dell'efficacia delle revisioni che sono 
				state fatte durante la Fase A. I motivi non sono facilmente comprensibili a causa dell'inesperienza del team, ma si può azzardare 
		...
		\subsubsection{PDCA}
			In questa sezione viene riportato il grafico PDCA della Fase A. In ascissa è rappresentato il tempo, in ordinata le attività.
			\begin{figure}[H]
				\centering
