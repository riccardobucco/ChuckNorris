...
\subsection{Organizzazione}
	...
	\begin{itemize}
		\item stesura dei documenti (ci si riferisce ad ogni documento esterno redatto durante lo svolgimento del progetto):
			\begin{itemize}
				...
				\item controllo del rispetto delle regole individuate nel documento "\insdoc{Norme di Progetto v\lastversion{}}".
			\end{itemize}
	...
	Tali scadenze si individuano nelle revisioni di seguito riportate:
		\begin{itemize}
			\item \rev{Revisione dei Requisiti}: \insdate{16}{02}{2015} (revisione formale);
			\item \rev{Revisione di Progettazione}:\insdate{24}{04}{2015} (revisione di progresso);
			\item \rev{Revisione di Qualifica}:\insdate{29}{05}{2015} (revisione di progresso);
			\item \rev{Revisione di Accettazione}:\insdate{18}{06}{2015} (revisione formale).
		\end{itemize}
	
	\subsection{Responsabilità}
	E' totalmente a carico del \role{Responsabile di Progetto} la responsabilità di accertare il corretto svolgimento delle attività di controllo della qualità e il loro esito.\\
	L'aggiornamento e il controllo dell'ambiente di sviluppo, nonchè del documento "\insdoc{Norme di Progetto}" è a carico degli \role{Amministratori di Sistema}.
	\subsection{Risorse}
	...
	\paragraph{Risorse umane}
		Le risorse umane impiegate, intese come figure professionali, sono indicate e definite nel documento "\doc{Norme di Progetto} \lastversion" alla sottosezione "Ruoli di progetto".
	...
	Gli strumenti utilizzati dal team per rendere la realizzazione del progetto il più efficace ed efficiente possibile sono indicati nel documento "\insdoc{Norme di progetto v\lastversion{}}" alla sezione "Ambiente di sviluppo".
