...
\section{Visione generale della strategia di verifica}
	...
	\subsection{Organizzazione}
		...
		\begin{description}
			...
			sono soggetti a una revisione. Dunque, quando è prevista l'attività di verifica riguardante tale fase (vedi \insdoc{Piano di Progetto}), i Verificatori 
		...
		\subsection{Responsabilità} \label{subsec:responsabilita}
			...
			\begin{itemize}
				...
				\item Verificatore:
				\begin{itemize}
					\item deve eseguire le procedure di verifica previste dal presente documento e descritte nelle \insdoc{Norme di Progetto};
					\item deve tracciare gli errori rilevati durante ciascuna fase del progetto affinchè possano essere risolti.
				\end{itemize}
			\end{itemize}
			Per maggiori dettagli circa i compiti assegnati a ciascun ruolo si vedano le \insdoc{Norme di Progetto}.
		\subsection{Risorse}
			\subsubsection{Risorse necessarie}
				...
				\paragraph{Risorse umane}
					...
					Una descrizione dettagliata di ciascun ruolo è presente all'interno delle \insdoc{Norme di Progetto}.
			...
			\subsubsection{Risorse disponibili}
				\paragraph{Risorse umane}
					...
					nel \insdoc{Piano di Progetto} e in generale in base alle decisioni del \insrole{Responsabile di Progetto}.
				\paragraph{Risorse software}
					...
					Una descrizione dettagliata di programmi e script a supporto delle attività di verifica può essere trovata nelle \insdoc{Norme di Progetto}.
				\paragraph{Risorse hardware}
					Sono disponibili (e per ora sufficienti) le seguenti risorse hardware:
					\begin{itemize}
						\item un computer portatile per ogni membro del team (dotato del sistema operativo comune indicato nelle \insdoc{Norme di Progetto}).
					\end{itemize}
