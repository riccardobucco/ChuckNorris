...
\subsection{Organizzazione}
	...
	Tali scadenze si individuano nelle revisioni di seguito riportate:
		\begin{itemize}
			\item Revisione dei Requisiti: \insdate{16}{02}{2015} (revisione formale);
			\item[Revisione di Progettazione]:\insdate{24}{04}{2015} (revisione di progresso);
			\item[Revisione di Qualifica]:\insdate{29}{05}{2015} (revisione di progresso);
			\item[Revisione di Accettazione]:\insdate{18}{06}{2015} (revisione formale).
		\end{itemize}
	...
	Gli strumenti utilizzati dal team per rendere la realizzazione del progetto il più efficace ed efficiente possibile sono indicati nel documento "Norme di progetto \lastversion" alla sezione "Ambiente di sviluppo".
	...
	\begin{description}
		...
		\begin{itemize}
			\item Walkthrough, cioè la lettura dell'oggetto della misurazione per cercare qualunque possibile errore;
		= 	\item Inspection, cioè la lettura mirata dell'oggetto della misurazione alla ricerca di errori ritenuti più probabili e frequenti.
		\end{itemize}
	\end{description}
	...
	\subsubsection{Metriche per i documenti}
		...
		Questo particolare indice si basa sulla lunghezza della parola e sulla lunghezza della frase rispetto al numero di lettere.
			...
			Ind. Gulpease = 89 + (300*#frasi - 10*#lettere)/#parole
