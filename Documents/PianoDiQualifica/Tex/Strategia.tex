...
\subsection{Organizzazione}
	Come indicato nel \insdoc{Piano di Progetto v1.0} si è scelto di utilizzare un modello di ciclo di vita incrementale. Caratteristica di questo modello è quella di far avanzare il progetto a partire da miglioramenti consolidati, pertanto il gruppo \groupname{} ha deciso di organizzare la strategia di verifica sulla base di verifiche delle diverse attività del processo di sviluppo, le quali avranno lo scopo di garantire la qualità dei risultati ottenuti e, di conseguenza la sicurezza nei miglioramenti raggiunti.\\
