\level{1}{Test}
	...
	Per la descrizione dei diversi tipi di test e della sintassi utilizzata per indicarli si rimanda alla sezione Test del documento \insdoc{Norme di Progetto v7.00}.
	\input{Tex/TestAccettazione.tex}
	\input{Tex/TestSistema.tex}
	\level{2}{Test di integrazione}
		Di seguito vengono riportati i test di integrazione, ovvero quei test che servono per verificare il corretto funzionamento di più moduli assemblati insieme. Per una descrizione completa della sintassi utilizzata nella descrizione di tali test si consulti il documento \insdoc{Norme di Progetto v7.00}. \\
