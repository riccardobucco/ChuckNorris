...
\section{Qualità di prodotto perseguite}
	...
	\subsection{Funzionalità}
		...
		Nello specifico, il \textit{framework} fornisce tutte funzionalità necessarie a garantire il rispetto dei requisiti indicati nel documento "\insdoc{Analisi dei Requisiti v\lastversion{}}", che vengono implementate nel modo ritenuto più efficace ed efficiente dal team di sviluppo.\\
		...
		Lo strumento individuato per la misurazione di questa qualità è il superamento dei test previsti nel documento "\insdoc{Analisi dei requisiti v\lastversion{}}".
	...
	\subsection{Usabilità}
		...
		A causa della natura fortemente soggettiva di questa qualità non è possibile definire una metrica, mentre per quanto riguarda gli strumenti per valutarla si rimanda al documento "\insdoc{Norme di progetto v\lastversion{}}".
	\subsection{Manutenibilità}
		...
		Lo strumento identificato per la misurazione di questa qualità è indicato nel documento "\insdoc{Norme di progetto v\lastversion{}}".
	\subsection{Efficienza}
		...
		Lo strumento identificato per la misurazione del tempo di latenza viene indicato nel documento "\insdoc{Norme di Progetto v\lastversion{}}".