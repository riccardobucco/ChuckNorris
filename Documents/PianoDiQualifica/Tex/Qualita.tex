...
\section{Qualità di prodotto perseguite}
	...
	\subsection{Usabilità}
		...
		A causa della natura fortemente soggettiva di questa qualità non è possibile definire una metrica, mentre per quanto riguarda gli strumenti per valutarla si rimanda al documento \insdoc{Norme di progetto v1.0}.
	\subsection{Manutenibilità}
		...
		Lo strumento identificato per la misurazione di questa qualità è indicato nel documento \insdoc{Norme di progetto v1.0}.
	\subsection{Efficienza}
		...
		Lo strumento identificato per la misurazione del tempo di latenza viene indicato nel documento \insdoc{Norme di Progetto v1.0}.