...
\begin{letter}{}
	...
	\begin{itemize}
		\item \insdoc{Analisi dei Requisiti v4.00} (\inspath{Esterni/AnalisiDeiRequisiti\_v4.00.pdf});
		\item \insdoc{Glossario v4.00} (\inspath{Esterni/Glossario\_v3.00.pdf});
		\item \insdoc{Norme di Progetto v4.00} (\inspath{Interni/NormeDiProgetto\_v4.00});
		\item \insdoc{Piano di Progetto v4.00} (\inspath{Esterni/PianoDiProgetto\_v4.00});
		\item \insdoc{Piano di Qualifica v4.00} (\inspath{Esterni/PianoDiQualifica\_v4.00});
