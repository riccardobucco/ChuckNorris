...
\begin{letter}{}
	...
	\begin{itemize}
		...
		\item \insdoc{Norme di Progetto v3.00} (\inspath{Interni/NormeDiProgetto\_v3.00.pdf});
		\item \insdoc{Piano di Progetto v3.00} (\inspath{Esterni/PianoDiProgetto\_v3.00.pdf});
		\item \insdoc{Piano di Qualifica v3.00} (\inspath{Esterni/PianoDiQualifica\_v3.00.pdf});
		\item \insdoc{Specifica Tecnica v1.00} (\inspath{Esterni/SpecificaTecnica\_v1.00.pdf});
		\item \insdoc{Verbale} (\inspath{Interni/VerbaleEsterno2015-03-07.pdf}).
	\end{itemize}
	I dettagli inerenti il consuntivo sono trattati in maniera approfondita nel \insdoc{Piano di Progetto v3.00} che consegnamo in allegato.
