...
\level{2}{Fase F}
	...
	\begin{itemize}
		...
		\item\textbf{Glossario}: vengono aggiunti al file \insfile{Glossario.xml} i vocaboli dei quali si ritiene necessaria una definizione formale. Alla fine di questa Fase Gieni quindi generato il documento \insdoc{Glossario v6.00}.
	\end{itemize}
