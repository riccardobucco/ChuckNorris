...
\section{Introduzione}
	...
	\subsection{Ciclo di vita}
		...
		\begin{description}
			...
			\item[Fase PA]: Caratterizzata dalla progettazione architetturale. Questa fase ha inizio quando il documento \doc{Analisi dei Requisiti} è nello stato tra acceptable e addressed (fine Fase AD) e termina con la \rev{Revisione di Progetto}. Verranno apportati incrementi ad alcuni prodotti dalle precedenti fasi, come \doc{Norme di Progetto}, \doc{Piano di progetto}, \doc{Glossario} e \doc{Piano di Qualifica}. Alla \rev{Revisione di Progetto} si prevede di consegnare il documento \doc{Specifica Tecnica}.
