...
\section{Introduzione}
	...
	\subsection{Ciclo di vita}
		...
		\begin{description}
			...
			\item[Fase PA]: Caratterizzata dalla progettazione architetturale. Questa fase ha inizio quando il documento \insdoc{Analisi dei Requisiti} è nello stato tra acceptable e addressed (fine Fase AD) e termina con la \insrev{Revisione di Progetto}. Verranno apportati incrementi ad alcuni prodotti dalle precedenti fasi, come \insdoc{Norme di Progetto}, \insdoc{Piano di progetto}, \insdoc{Glossario} e \insdoc{Piano di Qualifica}. Alla \insrev{Revisione di Progetto} si prevede di consegnare il documento \insdoc{Specifica Tecnica}.
