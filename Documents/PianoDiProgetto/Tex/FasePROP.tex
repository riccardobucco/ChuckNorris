...
\subsection{Fase PROP: Progettazione Requisiti OPzionali}
	...
	\begin{itemize}
		...
		\item \textbf{Codifica}: con quest'attività inizia lo sviluppo da parte dei programmatori dei requisiti opzionali. Sarà dunque seguito quanto riportato nel documento \insfile{Definizione di Prodotto v3.0};
		\item \textbf{Esecuzione test}: verranno eseguiti automaticamente tutti i test previsti dal documento \insdoc{Piano di Qualifica v 6.0};
