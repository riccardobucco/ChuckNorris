...
\level{2}{Fase PRD: Progettazione Requisiti Desiderabili}
	...
	\begin{itemize}
		...
		\item\textbf{Glossario}: Vengono aggiunti al file \insfile{Glossario.xml} i vocaboli dei quali si ritiene necessaria una definizione formale. Alla fine di questa fase vieni quindi generato il documento \insdoc{Glossario v5.00}.
	\end{itemize}
