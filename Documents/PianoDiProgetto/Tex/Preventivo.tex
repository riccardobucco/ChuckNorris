...
\section{Preventivo}
	...
	\subsection{Resoconto}
		...
		\subsubsection{Ore totali di investimento}
			Le ore di investimento sono le ore svolte non rendicontate. Durante la \insphase{Fase A} e la \insphase{Fase AD} le ore effettuate non sono a carico del committente.
			\paragraph{Suddivisione lavoro}
