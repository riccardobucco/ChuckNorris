...
\level{2}{Fase PD: Product Delivery}
	\textbf{Periodo}: dal \insdate{10}{05}{2015} al \insdate{11}{06}{2015} \\Questa fase comincia con la fine della \insphase{Fase CP} e termina con la scadenza della consegna per la \insrev{RA}.
	\begin{itemize}
