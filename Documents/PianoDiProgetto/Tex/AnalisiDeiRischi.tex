	...
	\level{2}{Livello dei requisiti}
		\level{3}{Comprensione dei requisiti}
			\begin{itemize}
				...
				\end{itemize}
				\item \textbf{Pianificazione}: Durante l'attività di analisi dei requisiti il team effettuerà più incontri con il Proponente in modo da assicurarsi di aver compreso in modo chiaro ogni requisito necessario al corretto sviluppo del progetto.
