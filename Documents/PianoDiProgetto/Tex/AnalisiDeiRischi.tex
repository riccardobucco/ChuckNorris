	...
	\level{2}{Livello organizzativo}
		\level{3}{Valutazione dei costi}
			\begin{itemize}
				...
				\item \textbf{Riscontro}: Durante la prima fase si è verificato un ritardo sull’attività di analisi. Tuttavia, grazie ad una attenta pianificazione, non si sono verificati ritardi nella consegna. La terza fase è stata conclusa con un ritardo nella stesura della versione finale della Specifica Tecnica, rendendo necessario un riassetto della pianificazione della fase successiva da parte del Responsabile di Progetto al fine di mantenere i termini temporali previsti nella quarta fase. Il ritardo è stato causato soprattutto da impegni personali dei componenti del team e dalla difficoltà di riuscire ad organizzare un incontro con il proponente entro i tempi inizialmente pianificati per la presentazione dell'architettura scelta.
			\end{itemize}
